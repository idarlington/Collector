...
trait JsonFormatSupport extends SprayJsonSupport {
  final case class Vehicle(id: String, heading : Double, latitude: Double, longitude: Double, run_id: String, route_id: String, seconds_since_report: Int, predictable: Boolean)
